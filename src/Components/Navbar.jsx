  ...
  return (
    <div className='py-12 px-10 '>
      ...
      <ul className='flex list-none gap-14 '>
        <NavLink to={'/'} className={(e)=>{return e.isActive?'text-xl font-medium text-[#b3dd62] border-[#b3dd62] border-b-4 rounded-sm transition-all ':''}}><li className='hover:text-[#b3dd62] '>Home</li></NavLink>
